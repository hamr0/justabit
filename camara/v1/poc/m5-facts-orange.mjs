...
//      see camara/v1/poc/README.md). The published threshold menu runs to `P180D` and
 ...
 *   it is stored and as `camara/v1/poc/README.md`'s runbook line yields it is ALREADY
