...
// Run: ORANGE_BASIC_AUTH="$(pass camara/orange_network | head -1)" node camara/v1/poc/m5-check-live.mjs
//
...
// `git log 8238d02..81f8da4 -- camara/v1/poc/m5-check-live.mjs` was EMPTY. Every
...
if (SUPPLIED === '') {
  ...
  console.error('     ORANGE_BASIC_AUTH="$(pass camara/orange_network | head -1)" node camara/v1/poc/m5-check-live.mjs\n');
