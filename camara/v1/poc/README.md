...
```
node camara/v1/poc/m1-check.mjs   # M1 attestation core — 20 cases (user-validated 20/20 at
                        #   `4446517`, 2026-08-18)
node camara/v1/poc/m2-check.mjs   # M2 blind envelope — 10 cases (user-validated 10/10 at
                        #   `4446517`, 2026-08-18)
node camara/v1/poc/m3-check.mjs   # M3 floor gate — 26 cases (user-validated 26/26 at
                        #   `4446517`, 2026-08-18)
node camara/v1/poc/m4-check.mjs   # M4 mock facts adapter — 42 cases (user-validated 42/42 at
                        #   `d85d3cf`/v0.5.0, 2026-08-18)
node camara/v1/poc/m5-check.mjs   # M5 orange facts adapter, OFFLINE — 67 cases (user-validated
...
ORANGE_BASIC_AUTH="$(pass camara/orange_network | head -1)" node camara/v1/poc/m5-check-live.mjs
...
node camara/v1/poc/m6-check.mjs   # M6 integration — 47 cases (user-validated 47/47 at
...
## The demo — `node camara/v1/poc/demo.mjs`

```
node camara/v1/poc/demo.mjs                    # mock backend: zero credentials, zero network
...
# quoting the notes.
ORANGE_BASIC_AUTH="$(pass camara/orange_network | head -1)" node camara/v1/poc/demo.mjs --backend orange
```
...
LIVE-CONFIRMED: the user re-ran `node camara/v1/poc/demo.mjs --backend orange` at tip
...
been closed: the user re-ran `node camara/v1/poc/demo.mjs --backend orange` at
